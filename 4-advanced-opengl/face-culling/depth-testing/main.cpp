...
int main()
{
    ...
    // --------------------
    shader.use();
    shader.setInt("texture1", 0); // we use only one texture unit
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        float n = 0.1f, f = 100.0f, angle = glm::radians(camera.Zoom), a_r = (float)CURR_WIDTH / CURR_HEIGHT;
        ...
        // cubes
        glEnable(GL_CULL_FACE); // enable only for cubes
        //glCullFace(GL_FRONT);
        //glFrontFace(GL_CW);
