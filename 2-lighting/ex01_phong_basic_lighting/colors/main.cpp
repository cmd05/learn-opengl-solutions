...
int main()
{
    ...
    float light_cube_path_radius = 2;
    float light_cube_velocity = 0.5;
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        lightPos.x = light_cube_path_radius * cos(time * light_cube_velocity);
        lightPos.z = light_cube_path_radius * sin(time * light_cube_velocity);
