...
int main()
{
    ...
    // these positions are in model space
    // the normals are defined for world space - since lighting calculations are done in world space
    // the normal vector would be the same for the vertices in both the world and model space

    // each vertex has it's corresponding normal
    float vertices[] = {
        // position             // normals
    ...
    float ambientStrength = 0.1, specularStrength = 0.5, shineValue = 32;
    float diffVal = 0.0;
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        ImGui::SliderFloat("Shininess Value", &shineValue, 0.0f, 256.0f);
        
        // for testing purposes. Diffuse value is actually computed based
        // on angle between normal of surface and lighting angle, however
        // for testing purposes we set the entire cube to a constant lighting value
        //ImGui::SliderFloat("Diffuse Value", &diffVal, 0.0f, 1.0f);
        ...
        // uniforms for strengths
        lightingShader.setFloat("ambientStrength", ambientStrength);
        lightingShader.setFloat("specularStrength", specularStrength);
        lightingShader.setFloat("shineValue", shineValue);
        lightingShader.setFloat("diffVal", diffVal);
