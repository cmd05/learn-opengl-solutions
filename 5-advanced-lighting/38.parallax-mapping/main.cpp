...
int main() {
    ...
    Shader light_shader("light-shader.vs", "light-shader.fs");
    ...
    while(!glfwWindowShouldClose(window)) {
        ...
        // render light source for visualization purpose
        light_shader.use();
...
// render a 1x1 quad in NDC with manually calculated tangent vectors
