...
void renderQuad()
{
    if (quadVAO == 0)
    {
        ...
        // we are calculating the tangent and bitangent for the surface which will be the
        // same for each vertex since triangle is a flat shape
        ...
        // send the triangles as well as their tangent and bitangent
        float quadVertices[] = {
